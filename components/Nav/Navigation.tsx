...
const Navigation = (props: Props) => {
  ...
  return (
    <nav className="fixed top-0 left-0 z-50 w-full px-6 py-3 flex items-center sm:justify-between bg-slate-100 bg-opacity-50 backdrop-blur dark:bg-slate-900 dark:backdrop-blur-lg dark:bg-opacity-50">
      <div>
